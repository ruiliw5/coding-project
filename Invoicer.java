...
public class Invoicer extends JFrame {
    ...
    public Invoicer(String name, String id) {
        ...
        JPanel billToPanel = new JPanel(new BorderLayout(0, 3)); 
        billToPanel.add(new JLabel("Bill To:"), BorderLayout.NORTH);
        billToTextArea = new JTextArea(2, 4);  
        billToTextArea.setLineWrap(true);      
        billToTextArea.setWrapStyleWord(true); 
        JScrollPane billToScrollPane = new JScrollPane(billToTextArea);
        billToScrollPane.setPreferredSize(new Dimension(80, 40));  
        billToPanel.add(billToScrollPane, BorderLayout.CENTER);

        // Ship To panel
        JPanel shipToPanel = new JPanel(new BorderLayout(0, 3)); 
        shipToPanel.add(new JLabel("Ship To:"), BorderLayout.NORTH);
        shipToTextArea = new JTextArea(2, 4);  
        shipToTextArea.setLineWrap(true);      
        shipToTextArea.setWrapStyleWord(true); 
        JScrollPane shipToScrollPane = new JScrollPane(shipToTextArea);
        shipToScrollPane.setPreferredSize(new Dimension(80, 40));  
        ...
        // Create a panel with a vertical BoxLayout to avoid extra spacing
        ...
        // Create panel for totals with BoxLayout
        ...
        // Create each row as a separate panel
    ...
    private void createNewInvoice() {
        ...
        stateComboBox.setSelectedItem("AK");
        premiumCustomerCheckBox.setSelected(false);
        noDiscountRadio.setSelected(true);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
        	Invoicer app = new Invoicer("Ruilin Wu", "51084996");
            app.setVisible(true);
        });
    }
}